...
def get_static_lmks(
        ...
        flame_static_embedding_path: str = "/home/juanjoflores/TFM/DAD-3DHeads/dad_3dheads_benchmark/data/static/flame_static_embedding.pkl"
) -> torch.Tensor:
    """
...
def get_dynamic_lmks(
        mesh_vertices: torch.Tensor,
        mesh_faces: torch.Tensor,
        contour_embeddings_path: str = "/home/juanjoflores/TFM/DAD-3DHeads/dad_3dheads_benchmark/data/static/flame_dynamic_embedding.npy"
) -> torch.Tensor:
    """
    mesh_vertices: torch.Tensor [N, 3]
    mesh_faces: torch.Tensor [M, 3]
...
def get_68_landmarks(
        mesh_vertices: torch.Tensor,
        mesh_faces_path: str = "/home/juanjoflores/TFM/DAD-3DHeads/dad_3dheads_benchmark/data/static/flame_mesh_faces.pt"
) -> torch.Tensor:
    """
    mesh_vertices: torch.Tensor [N, 3]
...
def calc_ch_dist(gt_vertices: torch.Tensor, pred_vertices: torch.Tensor, svn_pred_lmks: np.ndarray) -> float:
    ...
    ch = chamfer_distance(gt_face_vertices.view(1, -1, 3).cuda(), aligned_pred_vertices.view(1, -1, 3).cuda(), 1.0, 0.0)
    print("CULO"*50)
