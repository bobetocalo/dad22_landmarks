...
import numpy as np
from dad_3dheads_benchmark.utils import read_json
...
def demo(
    input_image_path: str = '/home/juanjoflores/TFM/DAD-3DHeads/prueba/e720602a-0f0b-4563-8fa6-506e969c2aa3.png',
    outputs_folder: str = "outputs",
    type_of_output: str = "pose",
) -> None:
