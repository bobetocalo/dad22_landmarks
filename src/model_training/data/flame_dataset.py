...
class FlameDataset(Dataset):
    ...
    def _load_mesh(mesh_path: str) -> MeshArrays:
        ...
        if "images/DAD-3DHeadsDataset/train/" in mesh_path:
            mesh_path = mesh_path.replace("images/DAD-3DHeadsDataset/train/","")
        else:
            mesh_path = mesh_path.replace("images/DAD-3DHeadsDataset/val/","")
