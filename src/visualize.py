...
def visualize(subset: str, id: str, base_path: str = 'dataset', outputs_folder: str = "outputs") -> None:
    ...
    """
    subset = 'train'
    id = '8020d5e5-2a03-4e57-8082-05e0b0b1064f'
    base_path = "/home/database8TB/dad-3dheads/"
    outputs_folder = "/home/juanjoflores/TFM/DAD-3DHeads/prueba"
    os.makedirs(outputs_folder, exist_ok=True)
    json_path = os.path.join(base_path, subset, 'annotations', id + '.json')
    print(json_path)
