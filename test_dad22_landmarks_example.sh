...
sudo docker run --name dad22_landmarks_container -v dad22_landmarks_volume:/home/username --rm -it -d dad22_landmarks_image bash
sudo docker exec -w /home/username/ dad22_landmarks_container python images_framework/alignment/dad22_landmarks/test/dad22_landmarks_test.py --input-data images_framework/alignment/dad22_landmarks/test/example.tif --database aflw --save-image
