...
rsync --delete -azvv /var/lib/docker/volumes/dad22_landmarks_volume/_data/conda/envs/dad22/lib/python3.8/site-packages/images_framework/output/images/ output
